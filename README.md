...
| Приложение | Инструкция |
|------------|------------|
| **Shadowrocket** | 1. Открой приложение → 2. Нажми "+" в правом верхнем углу → 3. Выбери "Тип: Подписка" → 4. Вставь ссылку на `sub_base64.txt` → 5. Нажми "Готово" |
...
### Локальный запуск
```bash
git clone https://github.com/hiztin/VLESS-PO-GRIBI.git
cd VLESS-PO-GRIBI
