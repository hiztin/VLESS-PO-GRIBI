...
|------------------------|
| **v2rayN** |  1. Открой приложение<br>2. Нажми "Подписки" в верхнем меню<br>3. Выбери "Управление подписками"<br>4. Нажми "Добавить"<br>5. Вставь ссылку на `sub_base64.txt`<br>6. Нажми "Обновить" |
| **Throne** |  1. Открой приложение<br>2. Нажми на "Профили" слева<br>3. Нажми "Добавить профиль из буфера"<br>4. Вставь ссылку на `sub_base64.txt` |
| **Clash Verge** |  1. Открой приложение<br>2. Перейди в "Подписки"<br>3. Вставь ссылку на `sub_base64.txt`<br>4. Нажми "Импортировать" |
| **Netch**  |  1. Открой приложение<br>2. Нажми "Подписки" → "Управление подписками"<br>3. Нажми "Добавить"<br>4. Вставь ссылку на `sub_base64.txt`<br>5. Нажми "Обновить" |
